...
\section{\glsentrytext{ofdm} Carrier Orthogonality \label{sect:proofs_ofdm-orthog}}
...
\section{Using the \glsentrytext{dft} in \glsentrytext{ofdm} systems \label{sect:proofs_ofdm-dft}}
