...
\begin{figure}[htbp]
  ...
  \caption{Time-domain plot of a handful of frames of a perfect \glsentrytext{dab} signal.}
...
One of the most important parts of the entire \gls{dab} processing chain was correct time-synchronisation. If the frame from the pre-processing block was misaligned, the entire demodulation process could break due to misalignment of the \gls{ofdm} symbols, thus causing havoc in the \gls{dqpsk} demodulation. Fortunately, the inclusion of a guard interval with cyclic prefixing provided some leeway, but errors could easily arise if one was not careful. It will later be shown how a result can be negatively affected by the incorrect alignment of a \gls{dab} frame.
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption{Plots showing the input to and output from the matched filter, when the \glsentrytext{prs} is detected.}
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption{Plots showing the input to- and output from the matched filter, when the \glsentrytext{prs} is erroneously detected due to the guard interval.}
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption{Plots showing the magnitude of the \glsentrytext{ofdm} carriers for a \glsentrytext{dab} symbol.}
...
\begin{figure}[htbp]
  ...
  \caption{Surface plot of the magnitude of the \glsentrytext{ofdm} carriers for perfect data}
...
\begin{figure}[htbp]
  ...
  \caption{Surface plot of the magnitude of the \glsentrytext{ofdm} carriers for real-world data.}
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption{Plots showing the phase of \glsentrytext{ofdm} carriers for a three consecutive \glsentrytext{dab} symbols of perfect data.}
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption{Plots shown on the complex plane of various data derived from a perfect \glsentrytext{dab} signal.}
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption{Plots shown on the complex plane of various data derived from a real-world \glsentrytext{dab} signal.}
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption{Plots shown on the complex plane of various data derived from a poor-quality \glsentrytext{dab} signal.}
...
\begin{figure}[htbp]
  ...
  \caption{Phase plot for the carriers of a real-world \glsentrytext{dab} symbol, before and after frequency deinterleaving.}
...
\begin{figure}[htbp]
  ...
  \caption{Interleave map for \glsentrytext{dab} Transmission Mode I.}
...
\begin{figure}[htbp]
  ...
  \caption{Graphic showing the assignment of \glsentrytext{dqpsk} data to one of four known values, based on the quadrant in which the data lies.}
...
\begin{figure}[htbp]
  ...
  \caption{Alternative plot of the \glsentrytext{dqpsk} snapping situation, viewed across the \(K\) carriers, showing the snapped values and decision boundaries.}
...
\begin{figure}[htbp]
  ...
  \caption{Demonstration of a section of the processing chain converting a noisy \glsentrytext{ofdm} symbol into a clean one.}
