...
\section{Objectives}
% The primary objective for this investigation was to research, design, and implement a working \gls{dab} modulator and demodulator in software. In doing this, recorded \gls{dab} signals could be fed into existing passive radar processing chains. 
