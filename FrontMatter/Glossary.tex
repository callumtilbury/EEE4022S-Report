...
\newacronym{dvbt}{DVB-T}{Digital Video Broadcasting - Terrestrial}
...
\newacronym{cazac}{CAZAC}{Constant-Amplitude Zero-AutoCorrelation}
\newacronym{ska}{SKA}{Square Kilometer Array}
\newacronym{dsi}{DSI}{Direct Signal Interference}
\newacronym{ecm}{ECM}{Electronic Countermeasures}
\newacronym{sfn}{SFN}{Single-Frequency Networks}
