...
\par\noindent\makebox[2.5in]{\includegraphics[width=0.3\linewidth]{../signature.png}}\hfill\makebox[2.0in]{11-November-2020}%
\par\noindent\makebox[2.5in]{\hrulefill} \hfill\makebox[2.0in]{\hrulefill}%
\par\noindent\makebox[2.5in][l]{Callum Rhys Tilbury}      \hfill\makebox[2.0in][l]{Date}%
